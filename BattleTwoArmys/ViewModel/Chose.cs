...
namespace BattleTwoArmys.ViewModel
{
    public class Chose
    {
        public static void Language()
        {
            ...
            var chosedNumberLang = Chose.Number(2);
        ...
        public static Type SubType(Type type)
        {
            ...
            var chosedNumberOfTypes = Chose.Number(countOfTypes);
        ...
        public static int Number(int maxNumber)
        {
            ...
            do
            {
                if (checkRightNumber)
                {
                    Console.WriteLine(StringsMenu.GetString("ChoseCorrectNumber"));
                }
                ...
                if (checkRightNumber)
                {
                    chosedNumber = int.Parse(readLine!);
                }
        ...
        public static Unit? UnitsArmy(int numberArmy)
        {
            switch (numberArmy)
            {
                case 1:
                    ...
                    break;
                case 2: Console.WriteLine(StringsMenu.GetString("GreenArmy"));
                    break;
                default:
                    throw new Exception("Chose 1 or 2");
            }
            var subTypeUnit = Chose.SubType(typeof(Unit));
